      SUBROUTINE DVOUT1 ( LOUT, N, SX, IDIGIT, IFMT )
*       Routine DVOUT1 is a wrapper around DVOUT that accepts scalar arguments.
*       RF, 2018.03-09
        ...
        DOUBLE PRECISION  SX1(1)
        SX1(1) = SX
        CALL DVOUT (LOUT, N, SX1, IDIGIT, IFMT)
      END SUBROUTINE
