      ...
      SUBROUTINE IVOUT1 (LOUT, N, IX, IDIGIT, IFMT)
C       Routine to handle scalar arguments IX that are all over the ARPACK
C       code, but which modern compilers won't accept if explicit interfaces
C       are used.
C       RF, 2018-03-09
        ...
        IX1(1) = IX
        CALL IVOUT (LOUT, N, IX1, IDIGIT, IFMT)
      END SUBROUTINE
